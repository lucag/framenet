...
window.flow = function (csv) {

  var cont = element.get(0);

  var positionInfo = cont.getBoundingClientRect();

  console.log(cont);

  console.log(positionInfo);

// var height0 = positionInfo.height;
// var width0 = positionInfo.width;
  ...
  var formatNumber = d3.format(",.0f"),    // zero decimal places
      format       = function (d) { return formatNumber(d) + " " + units + (d > 1 ? "s" : ""); },
...
// load the data
// d3.csv("pattern_1.csv", function(error, data) {
// d3.csv("pattern_1.csv", function(error, data) {
// d3.csv("pattern_2_core.csv", function (error, data) {
...
//   			.filter(function (n) { return n.core; });
...
//   	})
//   	.filter(function (d) {
//       return d.source.core && d.target.core;
  });

//   console.log('links:', graph.links);

  sankey
  //     .nodes(graph.nodes.filter(function (n) { return n.core; }))
    .nodes(graph.nodes)
    .links(graph.links)
    .layout(32);
