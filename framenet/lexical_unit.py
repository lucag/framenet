...
class ValencePattern(object):
    """Contains a list of valenceUnits (Valence objects), as well as associated annotations.
    This corresponds to a given valence pattern for an FEGroupRealization."""
    ...
    def __hash__(self):
        return hash(tuple(self.valenceUnits))
